...
export interface CuttingSummary {
  ...
  newBarsUsed?: number;                    // Count of new 12m bars used
  wastePiecesReused?: number;              // Count of waste pieces reused
  totalWasteLength: number;                // Total waste (from all bars)
  wasteFromNewBars?: number;               // Waste only from new 12m bars
  wasteFromReusedPieces?: number;          // Waste from reused waste pieces
